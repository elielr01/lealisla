...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
								...
								$q->execute(array($_GET['id']));
								 while ($row = $q->fetch()){
								 	echo "<h4>".$row['servicioEn']."</h4>";
								}
		                        ?>
		                        <button class="btn_en btn"><a href="agregarDetalle.php?id=<?php echo $_GET['id']?>">Español</a></button>
                        ...
                        <?php
						$all_recs = array();
						$sql = "SELECT * FROM detalleServicioEn where idServicio = ?";
						$q = $db->prepare($sql);
						$q->execute(array($_GET['id']));
						 while ($row = $q->fetch()){
    ...
    <script src="js/agregarDetalleEn.js"></script>
    <script>
