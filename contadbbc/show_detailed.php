 ...
 *
 * $Header: /cvs/bbclone/show_detailed.php,v 1.82 2005/04/03 20:26:35 olliver Exp $
 *
...
function bbc_show_connect_field($connect, $field, $lng, $titles = false) {
  ...
  switch ($field) {
    ...
    case "referer":
      ...
      return "<div align=\"left\">&nbsp;<a href=\"javascript:go('$url')\" rel=\"nofollow\" title=\""
            .$connect[$field]."\">$str</a></div>";
