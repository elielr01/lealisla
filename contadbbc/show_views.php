 ...
 *
 * $Header: /cvs/bbclone/show_views.php,v 1.30 2005/04/03 20:26:35 olliver Exp $
 *
...
function bbc_which_whois($addr) {
  ...
  return "(<a href=\"javascript:go('".(empty($url) ? "ws.arin.net/cgi-bin/whois.pl?queryinput=$addr" : $url)
        ."')\" rel=\"nofollow\" >Whois</a>)&nbsp;";
}
