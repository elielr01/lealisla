...
<body>
  ...
  <div id="main4" class="container">
    <div class="row text-center">
      <h1 class="text-left">Oportunidades</h1>
      <p  class="text-left">
        Buscamos estudiantes talentosos y con deseos de hacer una carrera profesional sobresaliente con nosotros. Si estás interesado, por favor envíanos un mensaje indicando tus áreas de interés y anexando tu Curriculum Vitae.
      </p>
      <br>
    </div>
    <br><br>
