          ...
          if(count($all_recs)>0)
          {
            foreach ($all_recs as $row) {
              ...
              foreach ($all_recs2 as $row2) {
                ...
                {
                  $pills = $pills."<span class='label label-default'>".$row2['tag_en']."</span> ";
                }
              }
              echo "<div class=col-md-12 style=padding:0px;margin-bottom:20px id=".$row['id'].">";
              echo "<h3 class=text-left><a href=n.php?id=".$row['id'].">".$row['titulo_en']."</a></h3>";
              echo "<span class=news_date>".$row['fecha2']."</span>";
              echo "<div>".$pills."</div>";
              echo "<p class=text-justify>".$row['resumen_en']."</p>";
        ...
        <div class="serach_box_news">
          ...
          <form action="search.php" method="GET">
            <div class="form-group">
              <input type="text" class="form-control" name="inicio" value='<?php echo $_GET['inicio']?>' id="inicio" placeholder="Start Date">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="fin" value='<?php echo $_GET['fin']?>' id="fin" placeholder="End Date">
            </div>
